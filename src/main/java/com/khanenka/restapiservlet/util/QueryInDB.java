...
public class QueryInDB {
    ...
    public static final String QUERY_DELETE_ORDER_DETAIL_PRODUCT_BY_ORDER_DETAIL_ID = "DELETE FROM order_detail_product" +
            " WHERE order_detail_id = ?";
    public static final String QUERY_CREATE_TABLE_ORDER_DETAIL = "CREATE TABLE if not exists order_detail" +
            " (order_detail_id  INT , order_status character varying(50) ,total_amount numeric(10,2))";
    ...
    public static final String QUERY_INSERT_PRODUCT_CATEGORY = "INSERT INTO productcategory (\"name\", \"type\")" +
            " VALUES ( ?, ?)";
    public static final String QUERY_SELECT_ALL_PRODUCT_CATEGORY = "SELECT DISTINCT \"name\",\"type\"" +
    ...
    public static final String QUERY_DELETE_PRODUCT_PRODUCT_CATEGORY_BY_PRODUCT_NAME = "DELETE" +
            " FROM product_productcategory WHERE \"nameproduct\" = ?";
